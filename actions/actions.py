...
from __future__ import absolute_import, unicode_literals # on importe ses from pour supporter les fonctionnalités du framework rasa au cas python installé dans le pc ne reconnait pas
...
from rasa_sdk.events import SlotSet # la classe SlotSet permet de stocker des informations en mémoire.
...
class ActionAfficherMenu(Action):
    ...
    def run(self, 
        ...
        menu = ""
        with open("C:/Users/Christine Gnama/chat_bot_stage/static/menu.txt", "r", encoding="UTF-8") as f:
            menu += f.read()
...
class ActionDemandeConfirmation(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
             ...
             domain: Dict[Text, Any]) -> List[Dict[Text, Any]]: 
        gerer_menu = tracker.latest_message['text']
        repas = open("C:/Users/Christine Gnama/chat_bot_stage/static/menu.txt", "r", encoding="UTF-8").readlines()
...
class ActionValiderConfirmation(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        addition = open("C:/Users/Christine Gnama/chat_bot_stage/static/prix.txt", "r", encoding="UTF-8").readlines()
        ...
        if reponse == "Oui" or reponse == 'oui' or reponse == 'O' or reponse == 'o':   
            ...
            dispatcher.utter_message(text="Veuillez demander le menu au serveur à nouveau !")
